...
Haravan.changeItem = function(id, quantity, callback) {
	var params = {
		type: 'POST',
		url: '/cart/change.js',
  ...
  ==============================================================================*/
	...
	formOverride = function () {
		$formContainer.on('submit', function(evt) {
			...
			Haravan.addItemFromForm(evt.target, itemAddedCallback, itemErrorCallback);
		});
	};
	...
	buildCart = function (cart) {
      ...
      */
			...
			var vt = cartItem.variant_options;
	...
	adjustCart = function () {
		...
		function updateQuantity(id_qty, qty) {
			isUpdating = true;
			// Add activity classes when changing cart quantities
			var $row = $('.ajaxcart__row[data-id="' + id_qty + '"]').addClass('is-loading');
			...
			setTimeout(function() {
				Haravan.changeItem(id_qty, qty, adjustCartCallback);
			}, 250);
		}
